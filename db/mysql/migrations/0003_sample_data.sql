...
-- Seed minimal supaya FK tidak gagal + contoh data doc_chunks

-- wells
INSERT IGNORE INTO wells (well_id, name, type, status, area)
VALUES ('WELL_B07','Well B07','Gas','active','Rig B07');

-- ts_signal
INSERT IGNORE INTO ts_signal (tag_id, asset_id, tag_name, unit, description)
VALUES ('OIL_D01','ASSET_01','Oil rate','bpd','Demo signal');

-- prod_allocation_daily (contoh)
INSERT IGNORE INTO prod_allocation_daily (date, well_id, gas_mmscfd)
VALUES ('2025-09-15','WELL_B07',3.2);

-- ts_value (contoh)
INSERT IGNORE INTO ts_value (tag_id, ts_utc, value, quality)
VALUES ('OIL_D01','2025-09-18 10:00:00',245.0,1);

-- ===============================
-- Seed doc_chunks (30 rows)
-- ===============================
INSERT IGNORE INTO doc_chunks (doc_id, title, url, snippet, page_no, embedding) VALUES
